...
try {
    ...
    & $mkcert -install
    & $mkcert "*.thenamelessexplorers.localhost"
    & $mkcert "thenamelessexplorers.xmcloudcm.localhost"
...
Add-HostsEntry "thenamelessexplorers.xmcloudcm.localhost"
Add-HostsEntry "www.thenamelessexplorers.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "thenamelessexplorers.xmcloudcm.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.thenamelessexplorers.localhost"
